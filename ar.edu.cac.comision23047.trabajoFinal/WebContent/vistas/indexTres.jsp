        ...
        <nav>
            ...
            <div class="dropdown contenido-nav d-block d-md-none">
                ...
                <ul class="dropdown-menu menu_lista">
                    <li><a class="dropdown-item" href="http://localhost:8080/ar.edu.cac.comision23047.trabajoFinal/vistas/index.jsp">La conferencia</a></li>
                    <li><a class="dropdown-item" href="#">Los oradores</a></li>
                    <li><a class="dropdown-item" href="http://localhost:8080/ar.edu.cac.comision23047.trabajoFinal/vistas/indexTres.jsp">Se un colaborador</a></li>
                    <li><a class="dropdown-item" href="#">Conviertete en orador</a></li>
                    <li><a class="dropdown-item liGreenn" href="http://localhost:8080/ar.edu.cac.comision23047.trabajoFinal/vistas/indexDos.jsp">Compra tikets</a></li>
                </ul>
            </div>
    ...
    <main>
        ...
        <div class="contenido_cards">
            <div class="cardUno">
                ...
                <a href="ColaboradoresController?accion=nuevo">Regístrate</a>
            </div>
            <div class="cardDos">
...
<footer>
        <div class="final">
            <div><a href="http://localhost:8080/ar.edu.cac.comision23047.trabajoFinal/vistas/indexTres.jspl#preguntasf">Preguntas frecuentes</a></div>
            ...
            <div><a href="http://localhost:8080/ar.edu.cac.comision23047.trabajoFinal/vistas/indexTres.jsp">Se un colaborador</a></div>
        </div>
    </footer>
